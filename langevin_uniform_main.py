...
from langevin_uniform import TSLangevin_uniform
...
if rank==rank:
    ...
    results_langevin.to_csv(r"/home/ks4n19/mnl_pytorch_code/coffee/langevin_uniform/B200/results_langevin_"+str(rank+30)+"T"+str(max_T)+"_B"+str(batch_size)+".csv", index=False)
