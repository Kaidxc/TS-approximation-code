...
class TSLaplace_normal:
    def __init__(
        ...
        """Thompson Sampling with Laplace approximation with normal prior
        ...
        self.alpha_post = torch.distributions.Normal(0,1).sample((K,))          
        self.beta_post =torch.distributions.Normal(0,1).sample((K,))                          
